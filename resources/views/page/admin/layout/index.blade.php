  ...
  <body>
    <div class="container-scroller">
          ...
          <div class="search-field d-none d-md-block">
            ...
            {!!Form::open(array('url'=>'admin/search','method'=>'get')) !!}
              <div class="input-group">
                ...
                <input type="text" name='search' value="{{request('search')}}" class="form-control bg-transparent border-0" placeholder="Search product">
              </div>
            {!!Form::close()!!}
            {{-- </form> --}}
          </div>
            ...
            <li class="nav-item nav-profile dropdown">
              <a class="nav-link dropdown-toggle" id="profileDropdown" href="#" data-bs-toggle="dropdown" aria-expanded="false">
                ...
                <div class="nav-profile-text">
                  <p class="mb-1 text-black">Vathan Tork</p>
                </div>
              </a>
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <!-- partial -->
        <div class="container-fluid mx-3 px-5 py-5">
          <div class='card-body'>
            {{-- inject main here --}}
            @yield('content')
          </div>
